...
setup(
    ...
    install_requires=[
        ...
        "bioio-lif","torchvision == 0.23.0","jsonschema == 4.25.1","flet-extended-interactive-viewer @ git+https://github.com/PraiseTheDarkFlo/flet-extended-interactive-viewer.git@older-flet-version"
    ],
    python_requires=">=3.8",
